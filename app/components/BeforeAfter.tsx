...
export default function BeforeAfter({
  ...
  const tagSize = isHero ? "text-[11px] py-1.5 px-3 gap-1.5 h-auto" : "text-xs py-2 px-3.5 gap-2";
  const dotSize = isHero ? "w-[7px] h-[7px]" : "w-2 h-2";
  const labelHeight = isHero ? "h-[30px]" : "h-8";
  const labelText = isHero ? "text-[11px] font-bold tracking-[1.5px]" : "text-xs font-semibold tracking-[1px]";
  ...
  return (
    <div
      ...
      style={{
        height,
        borderRadius: radius,
        border: border || "1px solid rgba(246,244,241,0.08)",
      }}
    ...
    >
      ...
      >
        ...
        />
        <div
          className={`absolute ${isHero ? "bottom-4 left-4" : "top-5 left-5"} inline-flex items-center gap-1.5 ${labelHeight} px-3.5 rounded-full ${labelText} z-[3] backdrop-blur-[8px]`}
      ...
      <div className="absolute inset-0" style={{ zIndex: 1 }}>
        ...
        />
        <div
          className={`absolute ${isHero ? "bottom-4 right-4" : "top-5 left-5"} inline-flex items-center gap-1.5 ${labelHeight} px-3.5 rounded-full ${labelText} z-[3] backdrop-blur-[8px]`}
          style={{
      ...
      >
        <div
          ...
          style={{ background: isHero ? "rgba(246,244,241,0.5)" : "rgba(246,244,241,0.6)" }}
        />
        <div
          ...
          style={{
            width: isHero ? "42px" : "44px",
            height: isHero ? "42px" : "44px",
            boxShadow: isHero
              ? "0 2px 10px rgba(0,0,0,0.3),0 0 0 3px rgba(246,244,241,0.15)"
              : "0 2px 8px rgba(0,0,0,0.25),0 0 0 3px rgba(246,244,241,0.2)",
          }}
        >

  ...
  return (
    <section className="sm-section">
      <div className="sm-inner">
        <div data-aos="fade-up" className="sm-header">
        ...
        <div data-aos="fade-up" data-aos-delay="100" className="sm-services-grid">
          {services.map((s, i) => (
            <Link
              key={s.id}
              href="/services"
        ...
        <div data-aos="fade-up" data-aos-delay="300" className="sm-materials">
          <h3 className="sm-materials-title">پالت متریال</h3>
          <div className="sm-materials-grid">
            {materials.map((m) => (
              <div key={m.id} className="sm-material-swatch">
                <div className="sm-material-color" style={{ background: m.color }} />
